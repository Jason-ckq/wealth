...
export const SELECT_NAME_CHANGE = 'ads-cloud/auth/SELECT_NAME_CHANGE';

export const LOAD_IOS_LINK = 'ads-cloud/auth/LOAD_IOS_LINK';
export const LOAD_IOS_LINK_SUCCESS = 'ads-cloud/auth/LOAD_IOS_LINK_SUCCESS';
export const LOAD_IOS_LINK_FAILED = 'ads-cloud/auth/LOAD_IOS_LINK_FAILED';
